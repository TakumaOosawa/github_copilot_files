...
4. 必要に応じてサブエージェントへ観点別レビューを委譲する
  ...
  - 06-06_review-test-adequacy へ委譲する場合は、test-result.md と test-execution-to-code-review.md に加えて、その参照元成果物に記載された test-spec-*.md を渡す
...
- code-review-to-implementation.md と code-review-to-test-specification.md と code-review-to-test-execution.md を同時に正式 handoff として残すこと
