...
- `${workspaceFolder}/.github/docs/templates/basic-design-template.md` をテンプレートとして使用する。
...
- シート相当の区切りや文書順は `${workspaceFolder}/.github/workflow-artifacts/cases/<case-id>/sources/basic-design/source-manifest.md` に記載された CSV 一覧と読み順に従う。
